...
Scenario Outline: Search the book by title of book
 ...
 Examples:      
  ...
  When the user "ansam" and the statuse "login" and the passward "1111" and search about the book by the  <type> with a string or substring <Word>
...
Scenario Outline: Search about more than one book with same information
  When the user  search about the book by the  <Typ> with a string or substringg <wor>
